...
# 이제 상대 경로 임포트
from src.core.content.generator.text.select_diagram import select_diagram, DiagramResult
from src.core.content.generator.svg import generate_diagram
from src.core.content.generator.svg.responsive_utils import create_simple_svg_fallback
